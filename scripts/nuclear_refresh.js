...
// --- THE NUCLEAR OPTION ---
// Delete EVERYTHING from products to ensure no unspecified/duplicate garbage remains
db.products.deleteMany({});
console.log("Database cleared.");

// Re-insert exactly 47 products
...
if (finalCount === 47) {
    console.log("✅ PERFECT SYNC: Exactly 47 products in database.");
} else {
    console.log("❌ SYNC FAILED: Count is " + finalCount);
}
